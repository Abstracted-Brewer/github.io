...
CSCO_Kirki::add_field(
	...
	array(
		...
		'output'       => apply_filters(
			...
			array(
				array(
					'element'  => 'body, .offcanvas, #search, select, input[type=search], input[type=text], input[type=number], input[type=email], input[type=tel], input[type=password], textarea, .form-control, .pk-card, .pagination-content, .adp-popup-type-content .adp-popup-container',
