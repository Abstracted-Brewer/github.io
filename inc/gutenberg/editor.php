...
function csco_change_editor_color_palette() {
	...
	add_theme_support(
		...
		array(
			...
			array(
				'name'  => esc_html__( 'Cyan bluish gray', 'networker' ),
			...
			array(
				'name'  => esc_html__( 'Vivid red', 'networker' ),
				'slug'  => 'vivid-red',
				'color' => '#ce2e2e',
			),
			array(
				'name'  => esc_html__( 'Luminous vivid orange', 'networker' ),
				'slug'  => 'luminous-vivid-orange',
				'color' => '#ff6900',
			),
			array(
				'name'  => esc_html__( 'Luminous vivid amber', 'networker' ),
				'slug'  => 'luminous-vivid-amber',
				'color' => '#fcb902',
			),
			array(
				'name'  => esc_html__( 'Light green cyan', 'networker' ),
				'slug'  => 'light-green-cyan',
				'color' => '#7bdcb5',
			),
			array(
				'name'  => esc_html__( 'Vivid green cyan', 'networker' ),
				'slug'  => 'vivid-green-cyan',
				'color' => '#01d083',
			),
			array(
				'name'  => esc_html__( 'Pale cyan blue', 'networker' ),
				'slug'  => 'pale-cyan-blue',
				'color' => '#8ed1fc',
			),
			array(
				'name'  => esc_html__( 'Vivid cyan blue', 'networker' ),
				'slug'  => 'vivid-cyan-blue',
				'color' => '#0693e3',
			),
			array(
				'name'  => esc_html__( 'Vivid purple', 'networker' ),
				'slug'  => 'vivid-purple',
				'color' => '#9b51e0',
			),
		)
