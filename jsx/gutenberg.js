...
if ('undefined' !== typeof csSchemeLocalize) {
  ...
  wp.data.subscribe(function () {
    ...
    if ('dark' === scheme) {
      document.getElementById('kirki-styles-dark-css').removeAttribute('media');
      document.getElementById('kirki-styles-default-css').setAttribute('media', "max-width: 1px");
    } else {
      document.getElementById('kirki-styles-default-css').removeAttribute('media');
      document.getElementById('kirki-styles-dark-css').setAttribute('media', "max-width: 1px");
    }
